...
local function run(msg, matches)
  if matches[1]:lower() == 'aghrab' then -- Put everything you like :)
  ...
  if matches[1]:lower() == "stats" then
    ...
    if matches[2] == "aghrab" then -- Put everything you like :)
...
return {
  patterns = {
    ...
    "^[!/]([Ss]tatslist)$",
    "^[!/]([Ss]tats) (group) (%d+)",
    "^[!/]([Ss]tats) (aghrab)",-- Put everything you like :)
		"^[!/]([Aa]ghrab)"-- Put everything you like :)
    }, 
  run = run
}
